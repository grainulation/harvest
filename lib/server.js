...
const SSE_SCRIPT = `
<div id="sseBanner" style="display:none;position:fixed;top:0;left:0;right:0;z-index:9999;padding:6px 16px;padding-top:calc(6px + env(safe-area-inset-top));background:rgba(239,68,68,0.9);color:#fff;font-size:12px;font-family:inherit;text-align:center;backdrop-filter:blur(8px)">Reconnecting...</div>
<script>
(function() {
  var banner = document.getElementById('sseBanner');
  var es, retryTimer;
  function connect() {
